...
<head>
    ...
    <style>
        ...
        /* Khung chọn ngôn ngữ nằm đúng chỗ khoanh đỏ */
        ...
        /* Đồng hồ góc dưới mỗi bong bóng chat */
...
<body>
    ...
    <!-- Khung chọn ngôn ngữ ngay góc trên bên trái -->
    ...
    <script>
        // Cấu hình múi giờ chuẩn quốc tế cho từng quốc gia
        const timeZones = {
            'vi': 'Asia/Ho_Chi_Minh',
            'ja': 'Asia/Tokyo',
            'zh': 'Asia/Shanghai',
        ...
        function appendMessage(content, sender, isHtml = false, timeStr = null) {
            ...
            if(!isHtml) {
                // Tạo element tạm để escape HTML nếu là text thuần
