...
<head>
    ...
    <style>
        ...
        /* Cụm Avatar góc phải có hiệu ứng nhịp thở */
        ...
        /* Khung chat rộng rãi và mượt mà */
        ...
        /* Hiệu ứng xuất hiện cho tin nhắn (Bay lên + hiện dần) */
        ...
        /* Bong bóng nhún nhảy khi AI đang soạn tin */
...
def chat():
    ...
    for item in client_history:
        if "typing-indicator" in item["content"] or "Lỗi" in item["content"]:
            continue
